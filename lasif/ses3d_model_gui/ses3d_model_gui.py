...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.mapView.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.colorbar.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.model_selection_comboBox.sizePolicy().hasHeightForWidth())
        self.model_selection_comboBox.setSizePolicy(sizePolicy)
        self.model_selection_comboBox.setMaximumSize(
        ...
        self.model_selection_comboBox.setObjectName(
            _fromUtf8("model_selection_comboBox"))
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.variable_selection_comboBox.sizePolicy().hasHeightForWidth())
        self.variable_selection_comboBox.setSizePolicy(sizePolicy)
        self.variable_selection_comboBox.setMaximumSize(
            QtCore.QSize(300, 16777215))
        self.variable_selection_comboBox.setEditable(False)
        self.variable_selection_comboBox.setProperty(
            "currentText", _fromUtf8(""))
        self.variable_selection_comboBox.setObjectName(
            _fromUtf8("variable_selection_comboBox"))
        ...
        self.plotted_depth_label.setObjectName(
            _fromUtf8("plotted_depth_label"))
        ...
        self.radio_button_absolute.setObjectName(
            _fromUtf8("radio_button_absolute"))
        self.horizontalLayout.addWidget(self.radio_button_absolute)
        self.radio_button_relative = QtGui.QRadioButton(self.groupBox)
        self.radio_button_relative.setObjectName(
            _fromUtf8("radio_button_relative"))
        ...
        self.clear_profiles_button.setObjectName(
            _fromUtf8("clear_profiles_button"))
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.depth_profile.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.plotted_depth_label.setText(
            _translate("MainWindow", "Plotted Depth", None))
        ...
        self.radio_button_absolute.setText(
            _translate("MainWindow", "Absolute", None))
        self.radio_button_relative.setText(
            _translate("MainWindow", "Relative", None))
        self.clear_profiles_button.setText(_translate(
            "MainWindow", "Clear all Profiles", None))
